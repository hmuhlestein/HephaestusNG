...
class TestCache:
    def test_store_and_get(self):
        from src.mcp.autopilot_api import _store, _cached, _invalidate
...
class TestQueueOrder:
    def test_save_and_load(self, tmp_path):
        from src.mcp.autopilot_api import _save_queue_order, _load_queue_order
        order_file = tmp_path / "order.json"
        with patch("src.mcp.autopilot_api._get_queue_order_path", return_value=order_file):
