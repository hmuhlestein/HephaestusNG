...
# TestGetProjectContextRepoAwareness (project_id/phase_name signature)
# removed: superseded by tests/test_agent_manager_project_context.py,
# which covers REQ-17/18/21 against the workflow_id/repo_id signature
