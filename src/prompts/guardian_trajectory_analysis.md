...
2. **Common Phase Violation Patterns**:
   ...
   - Steering: "The phase requires you to search for existing tickets before creating new ones. Please use heph_search_tickets() with hybrid search."
...
2. **Match to phase**:
   ...
   **completed**:
   - Called heph_complete_my_task with status='done'
...
- "You've completed the JWT authentication implementation. Please mark your task done using the heph_complete_my_task tool (status='done') and provide a summary of what was implemented."
