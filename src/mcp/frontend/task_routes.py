...
Each route is a top-level function that delegates to _shared.task_service.
"""
...
async def get_task(task_id: str):
    ...
    return await _shared.task_service.get_task(task_id)
...
async def get_task_full_details(task_id: str):
    ...
    return await _shared.task_service.get_task_full_details(task_id)
...
async def get_blocked_tasks(project_id: Optional[str] = None):
    ...
    return await _shared.task_service.get_blocked_tasks(project_id)
...
async def get_task_blocker_details(task_id: str):
    ...
    return await _shared.task_service.get_task_blocker_details(task_id)


@router.post("/sync-blocking-status")
async def sync_blocking_status():
    """Manually trigger sync of task blocking status."""
    return await _shared.task_service.sync_blocking_status()
