---
name: hephaestus-architecture-design
description: |
  Hephaestus Phase 2: Architecture Design
  Create detailed technical architecture and task breakdown.

Reads requirements_analysis.md from Phas...
