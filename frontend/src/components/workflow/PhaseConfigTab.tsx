...
export default function PhaseConfigTab({ details, loading }: PhaseConfigTabProps) {
  ...
  if (!details) {
    return (
      <div className="text-center py-8 text-gray-500 text-sm">No configuration available.</div>
    );
  }
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-gray-50 rounded-lg p-3">
          ...
          <div className="text-sm font-medium text-gray-800">
            {details.cli_tool || <span className="text-gray-400 italic">default</span>}
          </div>
        </div>
        <div className="bg-gray-50 rounded-lg p-3">
          <div className="flex items-center gap-2 text-xs text-gray-500 mb-1">
          ...
          <div className="text-sm font-medium text-gray-800">
            {details.cli_model || <span className="text-gray-400 italic">default</span>}
          </div>
        </div>
      </div>
